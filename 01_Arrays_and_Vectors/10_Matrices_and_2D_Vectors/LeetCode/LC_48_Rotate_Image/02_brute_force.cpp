...
10. `answer[column][n - row - 1] = matrix[row][column];`
   Updates `answer[column][n - row - 1]` to `matrix[row][column]` for the next step of the algorithm.
11. `matrix = answer;`
   Updates `matrix` to `answer` for the next step of the algorithm.
