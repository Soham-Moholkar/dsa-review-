...
One pointer reads; another records the next non-zero destination.
...
| Brute force | Use a new vector | O(n) | O(n) |
| Better | Overwrite then fill | O(n) | O(1) |
| Optimal | Stable swap | O(n) | O(1) |
