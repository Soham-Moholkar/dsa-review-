...
1. Forgetting k = k % n performs unnecessary work and can produce invalid split positions.
2. Using the reversal method on an empty array causes division by zero.
3. Rotating left instead of right changes the required segment order.
