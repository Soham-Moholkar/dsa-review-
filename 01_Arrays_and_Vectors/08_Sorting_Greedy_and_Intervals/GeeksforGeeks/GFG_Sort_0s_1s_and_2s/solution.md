# Sort 0s, 1s and 2s — explained solution
...
- **Better:** Count and overwrite. Time O(n); space O(1).
...
```bash
python3 scripts/test_solutions.py --problem GFG_Sort_0s_1s_and_2s --sanitize
```
