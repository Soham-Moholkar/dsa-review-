# First Missing Positive — explained solution
...
- **Brute Force:** Hash set. Time O(n); space O(n).
...
```bash
python3 scripts/test_solutions.py --problem LC_41_First_Missing_Positive --sanitize
```
