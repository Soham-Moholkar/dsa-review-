...
10. `leftSum = leftSum + arr[j];`
   Updates `leftSum` to `leftSum + arr[j]` for the next step of the algorithm.
...
12. `rightSum = rightSum + arr[j];`
   Updates `rightSum` to `rightSum + arr[j]` for the next step of the algorithm.
