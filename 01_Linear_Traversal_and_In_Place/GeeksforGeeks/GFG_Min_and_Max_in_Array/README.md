...
Two independent running extremes are required.
...
| Brute force | Sort the array | O(n log n) | O(log n) |
| Better | Two separate scans | O(n) | O(1) |
| Optimal | One combined scan | O(n) | O(1) |
