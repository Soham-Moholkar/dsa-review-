...
The question only asks whether the current value has appeared before.
...
| Better | Sort and compare neighbours | O(n log n) | O(log n) |
| Optimal | Hash set | O(n) average | O(n) |
