...
This particular file uses the "Hash set sequence starts" approach.
...
----------------------------
Approach name: Hash set sequence starts
...
12. `while(currentValue != INT_MAX && values.find(currentValue + 1) != values.end()) {`
