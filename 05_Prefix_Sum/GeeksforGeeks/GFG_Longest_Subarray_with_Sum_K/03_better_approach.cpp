...
This particular file uses the "Prefix sum with earliest-index map" approach.
...
----------------------------
Approach name: Prefix sum with earliest-index map
...
6. `map<long long, int> firstIndex;`
