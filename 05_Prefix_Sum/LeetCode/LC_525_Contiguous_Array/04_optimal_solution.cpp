...
This particular file uses the "Hashmap of earliest transformed prefixes" approach.
...
----------------------------
Approach name: Hashmap of earliest transformed prefixes
...
6. `unordered_map<int, int> firstIndex;`
